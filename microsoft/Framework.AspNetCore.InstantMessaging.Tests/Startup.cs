using Framework.AspNetCore.InstantMessaging.Application;
...
namespace Framework.AspNetCore.InstantMessaging.Tests
{
    public class Startup
    {
        ...
        {
            services
                .UseInstantMessagingApplication();
        }
